#!/usr/bin/env python3
#MoPAT Design Lab - Rahul D, Sai Rishi, Guining Pertin
#Robot Localization Node - 10-07-20

'''
This node identifies and localizes all the robots in the scene
Subscribed topics:
    /mopat/tracking/raw_image             -   sensor_msgs/Image (BGR)
Published topics:
    /mopat/tracking/color_segmented       -   
Work:
