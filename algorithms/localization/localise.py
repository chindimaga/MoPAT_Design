...
def localise ( LED_list ):
    ...
    while len(LED_list)>=3 :
        ...
        robot_list.append( [ centre( LED_list[0], LED_list[i1], LED_list[i2] ), angle( LED_list[0], LED_list[i1], LED_list[i2] ), ID_bit( LED_list[0], LED_list[i1], LED_list[i2] )  ])
